...
// StorageV1Client is used to interact with features provided by the storage.caoyingjunz.io group.
type StorageV1Client struct {
	restClient rest.Interface
}

func (c *StorageV1Client) LocalStorages() LocalStorageInterface {
